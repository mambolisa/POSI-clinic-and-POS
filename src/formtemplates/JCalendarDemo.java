...
public class JCalendarDemo extends JApplet implements PropertyChangeListener {
					...
					public void itemStateChanged(ItemEvent ie) {
						...
						if (rbmi2.isSelected()) {
							...
							try {
								...
								// look & feel
								//SwingUtilities.updateComponentTreeUI(com.toedter.calendar.demo.JCalendarDemo.this);
								for (int i = 0; i < beans.length; i++) {
									SwingUtilities
	...
	public static void main(String[] s) {
		...
		com.toedter.calendar.demo.JCalendarDemo demo = new com.toedter.calendar.demo.JCalendarDemo();
		demo.init();
	...
	class AboutAction extends AbstractAction {
		...
		private final com.toedter.calendar.demo.JCalendarDemo demo;
		 ...
		 *            Description of the Parameter
		 */
		AboutAction(com.toedter.calendar.demo.JCalendarDemo demo) {
			super("About...");
			this.demo = demo;
		}
