...
public class Warehouse extends posi.sys.expeditors.popup {
    ...
    private Object[][] data;
    private inventoryTable inv , inv_items;
    ...
    private javax.swing.JScrollPane warehouse_items( String warehouse_id ){
       ...
       // System.out.println(sql);
        ...
        inv_items = new inventoryTable( data, columnNames ){
            @Override
            public boolean isCellEditable(int row, int column) {
                return false;
            }
    ...
    private void item_transfer(String item_bar_code){
        top_mid_buttons_warehouse_transfer();
        label_list.setText("Transfer items");
        javax.swing.JPanel panel = new javax.swing.JPanel ( new java.awt.FlowLayout (  java.awt.FlowLayout.LEFT ) );        
        
        panel.add(panel_min);        
        items_transfer( panel , "Transfer item from warehouse", item_bar_code );
        
        splitpane.setRightComponent ( panel );
        splitpane.setDividerLocation(80);
    }
    
    private void items_transfer(javax.swing.JPanel panel, String border_title, String id_num){
